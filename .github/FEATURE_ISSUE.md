...
about: Want us to add any features to EmployeeManagerAngular?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with EmployeeManagerAngular. Please take the time to
...
<!--
  Why do you want to see this feature in EmployeeManagerAngular? What use cases does it support?
-->
